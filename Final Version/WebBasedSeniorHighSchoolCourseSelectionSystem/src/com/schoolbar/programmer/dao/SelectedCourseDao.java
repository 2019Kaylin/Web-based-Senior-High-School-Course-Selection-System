...
import com.schoolbar.programmer.model.SelectedCourse;

/**
 * 
 * @author 86136
 *Database course selection operation encapsulation
 */
public class SelectedCourseDao extends BaseDao {
	...
	/**
	 * Check whether the student has selected the course
	 * @param studentId
	 * @param courseId
	 * @return
	 */
	...
	/**
	 * Add course selection information
	...
	/**
	 * Get a piece of course selection data
	 * @param id
	 * @return
	 */
