	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'Student Name',width:200},
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("message reminder", "Sure to delete student information?", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>Gender:</td>
	    			<td><select id="add_gender" class="easyui-combobox" data-options="editable: false, panelHeight: 50, width: 60, height: 30" name="gender"><option value="male">male</option><option value="female">female</option></select></td>
	    		</tr>
	    		<tr>
	    			<td>Mobile:</td>
	    		...
	    		<tr>
	    			<td>Grade:</td>
	    			<td><input id="add_grade" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="grade" validType="number" /></td>
	    		</tr>
	    		<tr>
	    			<td>Class:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>Grade:</td>
	    			<td><input id="edit_grade" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="grade" validType="number" /></td>
	    		</tr>
	    		<tr>
	    			<td>Class:</td>
...
<!-- submit the form to process the iframe framework -->
